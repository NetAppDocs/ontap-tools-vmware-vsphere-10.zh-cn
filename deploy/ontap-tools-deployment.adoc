...
. 在“自定义模板”窗口中，填写必填字段。image:../media/custom-temp.png["自定义模板"]
+
...
. 使用 vCenter Server 8.0.3 版本时，在“自定义硬件”窗口中，启用“CPU 热添加”和“内存热插拔”选项，以启用 HA 功能。image:../media/customize-hw105.png["定制硬件"]
